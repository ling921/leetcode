...
namespace _33._Find_And_Replace_in_String
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine(solution.FindReplaceString(S, indexes, sources, targets));
        }
    }
    public class Solution
    {
        ...
        public int[] Adjust(int[] nums, int compare, int adj)
        {
